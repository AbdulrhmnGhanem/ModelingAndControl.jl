...
begin
	...
	p1 = scatter!(sampling_points, discretized_u₁;
		label="Sampled data",
	)
...
plot([
	scatter(sampling_points, [discretized_u₁, discretized_u₂];
...
begin
	...
	p3 = scatter!(sampling_points, discretized_u₂;
		label="Sampled data",
	)
